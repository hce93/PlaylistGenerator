        ...
        ScrollView{
            VStack{
                ...
                Spacer()
                    .frame(height: 10)
                Text("""
                ***Note this app is built for macOS***
                
                This app is built to update genre tags for your own music library and also generate playlists based off selected artists, albums or genres within your library. You can then save this playlist to your computers Apple Music app and listen from there. Below is a brief guide for each page:
                
                ***Update Genres***
                
                In this tab you are able to update genres in your music library by artist, whole albums or specific songs. To do so you can switch between the two "Artists" and "Albums" tabs. 
